...
jQuery(document).ready(function () {
    ...
    $('.changeLang').click(function () {
        ...
        var PageData = $("#PageUrl").data("url");

        $.post("/Base/ChangeLanguage", { LanguageID: LanguageID, PageUrl: PageUrl, PageData: PageData }, function (data) {
	...
	* --------------------------------------------------*/
    ...
    var scrollTrigger = 500, // px
        backToTopSoci = function () {
            var scrollTop = $(window).scrollTop();
            if (scrollTop > scrollTrigger) {
                $('#socicons').addClass('show');
            } else {
                $('#socicons').removeClass('show');
            }
        };
    backToTopSoci();
...
$(document).ready(function () {
    ...
    $(".owl-stage").trigger('play.owl.autoplay', [3000]);
    $("#mainmenu span").on("click", function () {

        $("#mainmenu .active").removeClass("active");
        $("#mainmenu .mega").css("height", "0");
        $("#mainmenu .tiny").css("height", "0");
        $(".menuActiveLink").removeClass("menuActiveLink");
        $(this).parents().children('a').addClass("menuActiveLink");
        $('html, body').animate({
            scrollTop: 30
        }, 500);
    })
